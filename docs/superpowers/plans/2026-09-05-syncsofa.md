...
- Browser-only behavior (camera, YT playback feel) is NOT verified by agents — it goes on the morning checklist at the end of this plan. Agents verify via typecheck, `vite build`, and vitest only.
